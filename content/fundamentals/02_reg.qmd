...
![Cause and Effect in Regression](/images/02_xy.png){fig-align="center" width="350"}
...
Looking at the regression summary, we see that the line is modeled by $y = -0.1918 + 0.3354*x$. It means that for the fitted model, an increase of one unit in $x$ is related to an 0.3354 increase in $y$.
...
#| include: false 
# Save data set
saveRDS(df, "../../datasets/02_reg/health_ins.rds")
```
...
# Read data set
df <- readRDS("../../datasets/02_reg/health_ins.rds")
```
