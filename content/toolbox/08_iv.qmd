...
# set themeggthemr::ggthemr(cds_theme, type = "outer")
...
ovb_dag <- ggdag_status(ovb, use_labels = "label", text = T) +
  guides(color = "none") +
  theme_dag() + 
  ggtitle("Omitted Variable Bias")
...
iv_dag <- ggdag_status(iv, use_labels = "label", text = T) +
  guides(color = "none") +
  theme_dag() + 
  ggtitle("Instrumental Variable Estimation")
# Plot both DAGS
ggpubr::ggarrange(ovb_dag,
  iv_dag,
  ncol = 2)
```
